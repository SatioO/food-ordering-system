package org.food.ordering.system.order.service.exception.handler;
...
@Slf4j
@ControllerAdvice
public class OrderGlobalExceptionHHandler extends GlobalExceptionHandler {
    @ResponseBody
    ...
    public ErrorDTO handleException(OrderNotFoundException orderNotFoundException) {
        ...
        return ErrorDTO.builder().code(HttpStatus.NOT_FOUND.getReasonPhrase()).message(orderNotFoundException.getMessage()).build();
    }
}
